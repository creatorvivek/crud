		...
		<div class="card card-default ">
  			...
  			<?= form_open('stu/add',array("class"=>"form-horizontal","id"=>"form_validation")); ?>
				...
				<div class="col-md-6">"
						...
						<div class="col-md-12">
						<input type="text" name="age" value="<?= $this->input->post("age"); ?>" class="form-control" id="age" required />
						...
						<div class="col-md-12">
						<input type="text" name="school" value="<?= $this->input->post("school"); ?>" class="form-control" id="school" required />
